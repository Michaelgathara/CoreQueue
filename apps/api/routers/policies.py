...
from apps.api.services.policy_service import list_policies, upsert_policy, dry_run
...
def apply_policy(body: PolicyIn, dry_run_only: bool = False, db: Session = Depends(get_session)):
    if dry_run_only:
